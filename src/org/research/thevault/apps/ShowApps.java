...
public class ShowApps extends ListFragment implements ListAdapter{
    ...
    */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    	View v = inflater.inflate(R.layout.show_apps, container, false);
        ...
        for( ApplicationInfo a : pm.getInstalledApplications(0) ) {
            if( ((String) a.loadLabel( getActivity().getPackageManager())).matches( "^[^\\.]+$" ) ) {
                loc.add(a);
            }
        }
        ...
        for( ApplicationInfo a : loc ) {
            ai.add( new AppWrapper( getActivity(), a ));
        }
